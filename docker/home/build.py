...
subprocess.call("rm -r /gateway/library/RyujiEv3", shell=True)
subprocess.call("cp -r /hrp2/sdk/common/library/RyujiEv3 /gateway/library", shell=True)
subprocess.call("rm -r /gateway/workspace/RO2020EV3", shell=True)
subprocess.call("cp -r /hrp2/sdk/workspace/RO2020EV3 /gateway/workspace", shell=True)
