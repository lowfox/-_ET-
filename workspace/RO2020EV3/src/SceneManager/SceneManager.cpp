...
SceneManager::SceneManager() {
  m_sceneMap.emplace(SceneID::LineTrace,
                     new LineTraceScene(static_cast<ISceneChanger*>(this)));
  m_sceneMap.emplace(SceneID::Garage,
                     new GarageScene(static_cast<ISceneChanger*>(this)));
  m_sceneMap.emplace(SceneID::Lookup,
                     new LookupScene(static_cast<ISceneChanger*>(this)));
  m_sceneMap.emplace(SceneID::Seesaw,
                     new SeesawScene(static_cast<ISceneChanger*>(this)));
