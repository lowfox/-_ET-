...
bool Stop() { return DriveEngine::GetDrive()->stop(); }

bool Rotate() { return DriveEngine::GetDrive()->rotate(); }

bool SetDriveMode(DriveMode mode) {
  return DriveEngine::GetDrive()->setDriveMode(mode);
}

DriveMode GetDriveMode() { return DriveEngine::GetDrive()->getDriveMode(); }
...
PID GetPID() { return DriveEngine::GetDrive()->getLineTraceDrive()->getPID(); }
