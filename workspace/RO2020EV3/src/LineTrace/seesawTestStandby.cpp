...
seesawTestStandby::seesawTestStandby() {
...
void seesawTestStandby::traceMain() {
...
int32 m_nowAngle= (RyujiEv3Engine::GetTailMotor()->getCounts());
if(!RyujiEv3Engine::GetTailMotor()->setCounts(0 - m_nowAngle,30,true)){
        EV3_LOG("standby.cpp..tail setCounts... Return false");
    }
}



void seesawTestStandby::setup() {
...
void seesawTestStandby::Calibration(int32 degree) {
...
bool seesawTestStandby::bluetoothDetection() {
...
bool seesawTestStandby::buttonDetection() {
...
bool seesawTestStandby::runStart() {
...
*/
	RyujiEv3Engine::GetTailMotor()->setCounts(0, TAIL_SPEED, true);
