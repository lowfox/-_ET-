...
class RyujiEv3Engine {
 ...
 public:
  ...
  ///
  static bool isActive() { return m_engine; }
  ...
  ///
  static IBluetooth* GetBluetooth() { return m_engine->m_bluetooth; }
  ...
  ///
  static IBattery* GetBattery() { return m_engine->m_battery; }
  ...
  ///
  static ILCD* GetLCD() { return m_engine->m_lcd; }
  ...
  ///
  static ILED* GetLED() { return m_engine->m_led; }
  ...
  ///
  static ISpeaker* GetSpeaker() { return m_engine->m_speaker; }
  ...
  ///
  static IMotor* GetLeftMotor() { return m_engine->m_leftMotor; }
  ...
  ///
  static IMotor* GetRightMotor() { return m_engine->m_rightMotor; }
  ...
  ///
  static IMotor* GetTailMotor() { return m_engine->m_tailMotor; }
  ...
  ///
  static IColorSensor* GetColorSensor() { return m_engine->m_colorSensor; }
  ...
  ///
  static IGyroSensor* GetGyroSensor() { return m_engine->m_gyroSensor; }
  ...
  ///
  static ITouchSensor* GetTouchSensor() { return m_engine->m_touchSensor; }
  ...
  ///
  static ISonarSensor* GetSonarSensor() { return m_engine->m_sonarSensor; }
};
}  // namespace RyujiEv3