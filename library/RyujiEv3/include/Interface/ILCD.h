...
namespace RyujiEv3
{
    ...
    public:
        ...
        ///
		/// @fn bool fillRect(int32 x, int32 y, int32 width, int32 height, LCD_Color color)
		/// @brief 指定領域を塗りつぶす
		/// @param x 左上
        /// @param y 左下
        /// @param width 右上
		...
		/// @retval false 失敗
		///
		virtual bool fillRect(int32 x, int32 y, int32 width, int32 height, LCD_Color color) = 0;
    };
}